...
export const InfraDbTypeEnum = {
  // 主流商业数据库
  ORACLE: { value: 'oracle', label: 'Oracle Database' },
  MSSQL: { value: 'mssql', label: 'Microsoft SQL Server' },
  DB2: { value: 'db2', label: 'IBM Db2' },

  // 开源数据库
  POSTGRESQL: { value: 'postgresql', label: 'PostgreSQL' },
  MYSQL: { value: 'mysql', label: 'MySQL/MariaDB' },
  SQLITE: { value: 'sqlite', label: 'SQLite' },

  // 国产数据库
  DM: { value: 'dm', label: '达梦数据库 (DM Database)' },
  KINGBASE: { value: 'kingbase', label: '人大金仓 (KingbaseES)' },
  OSCAR: { value: 'oscar', label: '神通数据库 (Oscar)' },
  HIGHGO: { value: 'highgo', label: '瀚高数据库 (HighGo DB)' },
  GBASE: { value: 'gbase', label: '南大通用 (GBase)' },
  GAUSSDB: { value: 'gaussdb', label: '华为 GaussDB' },

  // 其他数据库
  FIREBIRD: { value: 'firebird', label: 'Firebird' },
  SYBASE: { value: 'sybase', label: 'Sybase ASE' },
  INFORMIX: { value: 'informix', label: 'IBM Informix' },

  // NoSQL 数据库
  MONGODB: { value: 'mongodb', label: 'MongoDB' },
  REDIS: { value: 'redis', label: 'Redis' },
  CASSANDRA: { value: 'cassandra', label: 'Apache Cassandra' },
  NEO4J: { value: 'neo4j', label: 'Neo4j' },
  COUCHDB: { value: 'couchdb', label: 'Apache CouchDB' },
  MEMCACHED: { value: 'memcached', label: 'Memcached' },
  HBASE: { value: 'hbase', label: 'Apache HBase' },
  ARANGODB: { value: 'arangodb', label: 'ArangoDB' },
};
...
// ========== INFRA 模块 ==========
export enum InfraMqDefinitionStatusEnum {
  /**
   * 禁用
   */
  DISABLE = 1,
