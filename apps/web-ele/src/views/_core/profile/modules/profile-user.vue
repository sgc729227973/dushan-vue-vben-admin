  ...
  <div v-if="profile" class="profile-container">
    <div class="profile-content">
      ...
      <div class="mb-6 flex flex-col items-center">
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="mt-2 flex items-center">
            <ElTag type="primary">{{ profile.username }}</ElTag>
          </div>
        </div>
      ...
      <div class="user-info-list">
        ...
        <div v-if="profile.address" class="info-item">
          <IconifyIcon
        ...
        <div v-if="profile.skills" class="info-item">
      ...
      <!-- 个性标签 -->
      <div v-if="userTags && userTags.length > 0" class="tag-section mt-6">
