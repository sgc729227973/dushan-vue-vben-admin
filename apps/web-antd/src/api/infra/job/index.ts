...
export function deleteJobList(ids: number[]) {
  return requestClient.delete('/infra/job/delete-list', { data: ids });
}
...
/** 任务状态修改 */
export function updateJobStatus(data: InfraJobApi.JobStatus) {
  return requestClient.put('/infra/job/update-status', data);
}
